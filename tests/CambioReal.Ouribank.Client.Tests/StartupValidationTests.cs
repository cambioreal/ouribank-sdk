...
public sealed class StartupValidationTests
{
    ...
    {
        var services = new ServiceCollection();
        services.AddOuribankClient(options => { options.ApimKey = "apim"; options.Username = "user"; options.Password = "password"; options.ResourceCode = "resource"; options.CustomerCode = "customer"; options.AccountCode = "account"; options.CertificatePem = "certificate"; options.PrivateKeyPem = "private-key"; });
